...
export default function SwipingWords() {
    ...
    return (
        <div className="swipingWords absolute top-120 md:top-135 lg:top-155 left-0 w-full text-center -translate-y-5/5 z-0 pointer-events-none overflow-hidden h-[20vw]">
